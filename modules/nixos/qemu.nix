...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    boot = {
      kernelParams = [ "iommu=1" "intel_iommu=on" "vfio" "vfio_iommu_type1" "vfio_pci" "vfio_virqfd" ]; # or amd_iommu (cpu)
      ...
      extraModprobeConfig = ''
        ...
        options vfio-pci ids=${concatStringsSep "," cfg.vfioPciIds}
      '';
    };
  };
}
...
# GUIDE
#https://raw.githubusercontent.com/HikariKnight/vfio-setup-docs/master/A%20streamlined%20VFIO%2BLookingGlass%20setup%20guide.pdf

## using existing windows partition
#https://gist.github.com/Francesco149/dc156cfd9ecfc3659469315c45fa0f96


#https://quantum5.ca/2022/09/18/windows-vm-gpu-passthrough-part-3-setting-up-looking-glass/
